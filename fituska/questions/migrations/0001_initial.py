    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('validity', models.BooleanField(blank=True, verbose_name='type')),
                ('points', models.DecimalField(blank=True, decimal_places=0, max_digits=5)),
                ('teacher_points', models.DecimalField(blank=True, decimal_places=0, max_digits=5)),
            ],
            options={
                'abstract': False,
            },
